...
If (Request.QueryString("cod_situacao") <> "") Then 
  rs_delete_us__MMColParam = Request.QueryString("cod_situacao")
End If
%>
<%
Dim rs_delete_us
...
rs_delete_us.Source = "SELECT * FROM tb_situacao_pi WHERE cod_situacao = " + Replace(rs_delete_us__MMColParam, "'", "''") + ""
...
<form id="form1" name="form1" method="POST" action="<%=MM_editAction%>">
  ...
  <input type="hidden" name="MM_recordId" value="<%= rs_delete_us.Fields.Item("cod_situacao").Value %>">
...
<div align="center">
  <table border="0">
    <tr bgcolor="#CCCCCC">
      <td><span class="style5">Situa&ccedil;&atilde;o:</span></td>
      <td><span class="style5">Status:</span></td>
    </tr>
    <% While ((Repeat1__numRows <> 0) AND (NOT rs_delete_us.EOF)) %>
      <tr bgcolor="#CCCCCC">
        <td><span class="style3"><%=(rs_delete_us.Fields.Item("desc_situacao").Value)%></span></td>
        <td><span class="style3"><%=(rs_delete_us.Fields.Item("cod_atendimento").Value)%></span></td>
      </tr>
      <% 

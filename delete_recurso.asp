...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "tb_recurso"
  MM_editColumn = "id"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "cad_recurso.asp"
...
strQ = "SELECT tb_recurso.*, tb_tipo_recurso.nme_tipo_recurso FROM tb_recurso INNER JOIN tb_tipo_recurso ON tb_recurso.cod_tipo_recurso = tb_tipo_recurso.id where tb_recurso.id = " + Replace(rs_delete_us__MMColParam, "'", "''") + ""

...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_fieldsStr  = "num_outorga|value|dta_concessao|value|dta_vencimento|value|dsc_observacoes|value|flg_receber_notificacoes|value"
  MM_columnsStr = "num_outorga|',none,''|dta_concessao|',none,NULL|dta_vencimento|',none,NULL|dsc_observacoes|',none,''|flg_receber_notificacoes|none,1,0"

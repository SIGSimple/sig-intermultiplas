...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "tb_convenio_licitacao"
  MM_editColumn = "id"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "cad_convenio_licitacao.asp"
...
strQ = "SELECT * FROM c_lista_convenio_licitacao WHERE id = " + Replace(rs_delete_us__MMColParam, "'", "''") + ""

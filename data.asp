...
<table width="973" border="0">
  <tr>
    <td width="315"><form id="form1" name="form1" method="post" action="">
...
%>
    ...
    <td width="109"><a href=# onclick="Javascript:print()"><img src=imagens/imprimir.gif width="43" height="28" /></a></td>
    <td width="110"><div align="center"><a href="qtde_pi.asp" target="_blank" class="style6"></a></div></td>
    <td width="123">

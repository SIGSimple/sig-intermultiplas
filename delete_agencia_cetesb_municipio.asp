...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "tb_agencia_cetesb_municipio"
  MM_editColumn = "id"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "cad_agencia_cetesb_municipio.asp"
...
strQ = "SELECT * FROM c_lista_agencias_cetesb_municipios WHERE id = " + Replace(rs_delete_us__MMColParam, "'", "''") + ""

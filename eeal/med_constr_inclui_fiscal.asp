...
%>
    ...
    <tr valign="baseline">
      ...
      <td bgcolor="#CCCCCC"><input name="Valor_da_Medio" type="text" value="" size="18" /></td>
    </tr>
    <tr valign="baseline">
      <td align="right" nowrap bgcolor="#CCCCCC"><span class="style9">Porcentagem de Avanço:</span></td>
      <td bgcolor="#CCCCCC"><input type="text" name="Porcentagem_de_Avano" value="" size="12" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td bgcolor="#CCCCCC"><input type="text" name="Valor_do_Contrato" value="" size="18" /></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td bgcolor="#CCCCCC"><textarea name="informacao_placa" cols="15" id="informacao_placa"><%=(rs_med_constr.Fields.Item("Informação da Placa de Obra").Value)%></textarea></td>
    </tr>
    <tr valign="baseline">

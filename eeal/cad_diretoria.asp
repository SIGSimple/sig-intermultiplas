...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  MM_fieldsStr  = "desc_diretoria|value"
  MM_columnsStr = "desc_diretoria|',none,''"
...
<form method="post" action="<%=MM_editAction%>" name="form1">
  <table align="center">
    <tr valign="baseline" class="style5">
      <td nowrap align="right">Nome da Diretoria:</td>
...
<div align="center">
  <table border="0">
    <tr bgcolor="#999999" class="style5">
      ...
      <td><span class="style8">Nome da Diretoria </span></td>
    </tr>

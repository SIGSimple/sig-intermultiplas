...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  MM_fieldsStr  = "Responsvel|value|cargo|value|email|value|telefone|value"
  MM_columnsStr = "Responsável|',none,''|cargo|',none,''|email|',none,''|telefone|',none,''"
...
rs_resp.Source = "SELECT * FROM tb_responsavel ORDER BY Responsável ASC"
...
<body>
<p align="center"><strong><span class="style17">Cadastro de Fiscais </span></strong></p>
...
<div align="center">
  <table border="0">
    <tr bgcolor="#999999">
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><span class="style7">cod_fiscal</span></td>
    ...
    <% While ((Repeat1__numRows <> 0) AND (NOT rs_resp.EOF)) %>
      <tr bgcolor="#CCCCCC">
        <td><a href="altera_resp.asp?cod_fiscal=<%=(rs_resp.Fields.Item("cod_fiscal").Value)%>"><img src="depto/imagens/edit.gif" width="16" height="15" border="0" /></a></td>
        <td><a href="del_resp.asp?cod_fiscal=<%=(rs_resp.Fields.Item("cod_fiscal").Value)%>"><img src="depto/imagens/delete.gif" width="16" height="15" border="0" /></a></td>
        <td><span class="style5"><%=(rs_resp.Fields.Item("cod_fiscal").Value)%></span></td>

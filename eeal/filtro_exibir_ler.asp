...
<div align="center">
  <table border="0">
    <tr bgcolor="#666666">
      ...
      <td width="308"><span class="style9">Descri&ccedil;&atilde;o da Interven&ccedil;&atilde;o FDE</span></td>
      <td width="180"><span class="style9">Situa&ccedil;&atilde;o</span></td>
    </tr>
    <% While ((Repeat2__numRows <> 0) AND (NOT rs_filtro_combo.EOF)) %>
      <tr bgcolor="#CCCCCC">
        <td><a href="acompanhamento_inclui_ler.asp?pi=<%=(rs_filtro_combo.Fields.Item("PI").Value)%>" target="_blank" class="style15"><%=(rs_filtro_combo.Fields.Item("PI").Value)%></a></td>
        <td><div align="left"><span class="style15"><%=(rs_filtro_combo.Fields.Item("Descrição da Intervenção FDE").Value)%></span></div></td>

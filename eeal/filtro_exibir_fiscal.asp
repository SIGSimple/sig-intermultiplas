...
<div align="center">
  <table border="0">
    <tr bgcolor="#666666">
      ...
      <td width="248"><span class="style9">Situa&ccedil;&atilde;o</span></td>
    </tr>
    <% While ((Repeat2__numRows <> 0) AND (NOT rs_filtro_combo.EOF)) %>
      <tr bgcolor="#CCCCCC">
        <td><a href="atualiza_PI_fiscal.asp?pi=<%=(rs_filtro_combo.Fields.Item("PI").Value)%>" class="style15"><%=(rs_filtro_combo.Fields.Item("PI").Value)%></a></td>

...
Recordset1.Source = "SELECT *  FROM cDataRel  WHERE pi LIKE '%" + Replace(Recordset1__MMColParam, "'", "''") + "%' and cod_predio is not null"
...
If (Request.Form("pi")  <> "") Then 
  Recordset2__MMColParam = Request.Form("pi") 
End If
%>
<%
Dim Recordset2
...
Recordset2.Source = "SELECT count(pi) as contar  FROM cDataRel  WHERE pi LIKE '%" + Replace(Recordset2__MMColParam, "'", "''") + "%' and cod_predio is not null"
...
<table width="905" border="0">
  <tr>
    <td width="375"><form id="form1" name="form1" method="post" action="">
      <span class="style15">Digite o numero do PI</span>
          <input name="pi" type="text" id="pi" size="15" />
      <label for="Submit"></label>
      <input type="submit" name="Submit" value="Ok" id="Submit" />
    </form>    </td>
    <td width="47"><a href=# onclick="Javascript:print()"><img src=imagens/imprimir.gif width="43" height="28" /></a></td>
    <td width="27"><div align="center"><a href="qtde_pi.asp" target="_blank" class="style6"></a></div></td>
    <td width="14">
...
<table cellspacing="0" cellpadding="0" width="100%" height="100%">
	...
	<p align="center"></td>
    <td width="488">
	  <img border="0" src="imagens/logo_Arcadis.jpg" width="100%" height="32"></td>
  </tr>
  <tr>
    <td colspan="5"><!--[if gte vml 1]><v:line

...
If (Request.Form("Nome_Unidade") <> "") Then 
  Recordset1__MMColParam = Request.Form("Nome_Unidade")
End If
%>
<%
Dim Recordset1
...
Recordset1_cmd.CommandText = "SELECT * FROM cLista_pi WHERE Nome_Unidade LIKE ?" 
...
<body>
<p><a href="http://www.cep-escolas.com.br/busca_pi_unidade_fiscal.asp" class="style15">VOLTAR</a></p>
<p class="style1">Relação de PIs do SISTEMA CEP-ESCOLAS</p>
<table width="4244" border="0" bgcolor="#FFFFFF">
  <tr bgcolor="#999999">
    <td colspan="2" bgcolor="#CC9933" class="style16"><div align="center" class="style20">A Ç Õ E S</div></td>
  ...
  <tr bgcolor="#CC9933">
    <td colspan="2" class="style16"><div align="center"><span class="style20">Atualizar / Incluir</span></div></td>
  </tr>
  <% While ((Repeat1__numRows <> 0) AND (NOT Recordset1.EOF)) %>
    <tr bgcolor="#CCCCCC" class="style4">
      <td width="30" bgcolor="#CC9933"><div align="center"><a href="atualiza_PI_fiscal.asp?pi=<%=(Recordset1.Fields.Item("PI").Value)%>" target="_self" class="style23"><strong>PI</strong></a></div></td>
      <td bgcolor="#CC9933"><span class="style23"><a href="acompanhamento_inclui.asp?PI=<%=(Recordset1.Fields.Item("PI").Value)%>" class="style23">ACOMPANHAMENTO</a></span>        <div align="center"></div></td>

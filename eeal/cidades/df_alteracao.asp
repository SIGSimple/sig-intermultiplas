...
If Not IsEmpty(Request.Form("salvar")) Then
  ...
  If indice <> "" Then strQ = " SELECT * FROM tb_Municipios WHERE " & indice
...
<%If objRS.Fields("cod_mun").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=50" type="text" name="cod_mun" maxlength="255" value="<%=(objRS.Fields.Item("cod_mun").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("cod_mun").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>Municipios<br>
<%If objRS.Fields("Municipios").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Municipios" maxlength="255" value="<%=(objRS.Fields.Item("Municipios").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("Municipios").Value) & "</B>"
End If
%>
  </TD></TR>
</TABLE>

...
Recordset1_cmd.CommandText = "SELECT * FROM c_Semaforico WHERE cod_situacao = ?" 
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="994" border="0">
    <tr bgcolor="#CCCCCC">
      <td colspan="2" class="style10">RELAT&Oacute;RIO DE OBRAS - <strong>SEMAF&Oacute;RICO</strong><strong class="style10"> - por Pr&eacute;dio</strong></td>
      <td width="319"><div align="right"><img src="imagens/logo_Arcadis.jpg" width="475" height="52" /></div></td>
    </tr>

    <tr>
      <td width="371">&nbsp;</td>
      <td width="290"><span class="style12"><%=(Recordset3.Fields.Item("desc_situacao").Value)%></span></td>
...
%>
  ...
  <label>
<script language="JavaScript">
document.write("<font color='#GGGGGG' size='1' face='arial'>") 
var mydate=new Date()
...
<table width="2846" border="0">
  <tr bgcolor="#999999">
    <td width="102" rowspan="2"><span class="style5">C&oacute;digo do Pr&eacute;dio</span></td>
    <td width="60" rowspan="2"><span class="style5">PI-&Iacute;tem</span></td>
    <td width="121" rowspan="2"><span class="style5">Nome da Unidade </span></td>
    <td width="96" rowspan="2"><span class="style5">Munic&iacute;pio</span></td>
    <td width="106" rowspan="2"><span class="style5">Construtora</span></td>
    <td width="112" rowspan="2"><span class="style5">Fiscal</span></td>
    <td width="82" rowspan="2"><span class="style5">&Oacute;rg&atilde;o</span></td>
    <td width="53" rowspan="2"><span class="style5">Iternven&ccedil;&atilde;o FDE </span></td>
    <td colspan="3"><div align="center"><span class="style5">Valor (x1.000) / % Financeiro</span></div></td>
    <td width="133" rowspan="2"><span class="style5">N&ordm; &Uacute;ltima Medi&ccedil;&atilde;o </span></td>
    <td width="60" rowspan="2"><span class="style5">Data da Abertura </span></td>
    <td width="39" rowspan="2"><span class="style5">Prazo do Contrato </span></td>
    <td width="38" rowspan="2"><span class="style5">Dias Corridos &agrave; partir da OIS </span></td>
    <td width="46" rowspan="2"><span class="style5">Dias Corridos X Prazo Contratual </span></td>
    <td width="128" rowspan="2"><span class="style5">% Avan&ccedil;o F&iacute;sico Anterior</span></td>
    <td width="35" rowspan="2"><span class="style5">% Avan&ccedil;o F&iacute;sico Atual</span></td>
    <td width="46" rowspan="2"><span class="style5">T&eacute;rmino Contratual </span></td>
    <td width="40" rowspan="2"><span class="style5">Previs&atilde;o de T&eacute;rmino </span></td>
    <td width="23" rowspan="2"><span class="style5">Data do TRP </span></td>
    <td width="97" rowspan="2"><p class="style5">Medi&ccedil;&atilde;o Final SIM/N&Atilde;O </p></td>
    <td width="23" rowspan="2"><span class="style5">Data do TRD </span></td>
    <td width="359" rowspan="2"><span class="style5">A&ccedil;&otilde;es</span></td>
  </tr>
  <tr bgcolor="#999999">
    <td width="95">&nbsp;</td>
    <td width="128"><span class="style5">Anterior</span></td>
    <td width="112"><span class="style5">Atual</span></td>
  </tr>

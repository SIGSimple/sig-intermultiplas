...
<body>
<p><a href="http://www.cep-escolas.com.br/busca_pi_unidade.asp" class="style15">VOLTAR</a></p>
...
<table width="4244" border="0" bgcolor="#FFFFFF">
  ...
  <% While ((Repeat1__numRows <> 0) AND (NOT Recordset1.EOF)) %>
    <tr bgcolor="#CCCCCC" class="style4">
      <td width="30" bgcolor="#CC9933"><div align="center"><a href="atualiza_PI_adm.asp?pi=<%=(Recordset1.Fields.Item("PI").Value)%>" target="_self" class="style23"><strong>PI</strong></a></div></td>
      <td width="79" bgcolor="#CC9933"><span class="style23"><a href="acompanhamento_inclui_admin.asp?PI=<%=(Recordset1.Fields.Item("PI").Value)%>" target="_blank" class="style23">ACOMPANHAMENTO</a></span></td>

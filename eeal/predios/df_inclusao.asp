...
<%If objRS.Fields("cod_predio").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="cod_predio" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
<%
Else
...
<%If objRS.Fields("Nome_Unidade").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Nome_Unidade" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("Área Total").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Área Total" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("CEP").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="CEP" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("Área Construída").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Área Construída" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("Complemento").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Complemento" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("Endereço").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Endereço" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("Área Ocupada").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Área Ocupada" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("Número de Pavimentos").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Número de Pavimentos" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("Número de Salas").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Número de Salas" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
<%
Else
  Response.Write "<B>(Automático)</B>"
End If

...
pagina_consulta = "df_consulta_c.asp"
...
<p><a href="<%=pagina_inclusao%>" class="texto_pagina">
</a></p>
...
%>
  ...
  <TD style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Complemento+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 11) = "Complemento" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Complemento</b></TD>
  ...
  <TD style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=CEP+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 3) = "CEP" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>CEP</b></TD>
  <TD style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Área Total+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 10) = "Área Total" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Área Total</b></TD>
  </TR>
...
%>
    ...
    <TD><%=(objRS.Fields.Item("Endereço").Value)%></TD>
    <TD><%=(objRS.Fields.Item("Complemento").Value)%></TD>
    <TD><%=(objRS.Fields.Item("Município").Value)%></TD>

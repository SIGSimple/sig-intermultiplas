...
If Trim(Request("string_busca")) <> "" Then
  ...
  Else
    ...
    strQ = strQ & " Or Endereço LIKE '%" & Trim(Request("string_busca")) & "%'"
    strQ = strQ & " Or CEP LIKE '%" & Trim(Request("string_busca")) & "%'"
    strQ = strQ & " Or Complemento LIKE '%" & Trim(Request("string_busca")) & "%'"
    strQ = strQ & " Or Área Ocupada LIKE '%" & Trim(Request("string_busca")) & "%'"
    strQ = strQ & " Or Área Construída LIKE '%" & Trim(Request("string_busca")) & "%'"
    strQ = strQ & " Or Diretoria de Ensino LIKE '%" & Trim(Request("string_busca")) & "%'"
    strQ = strQ & " Or Área Total LIKE '%" & Trim(Request("string_busca")) & "%'"
    strQ = strQ & " Or Número de Pavimentos LIKE '%" & Trim(Request("string_busca")) & "%'"
    strQ = strQ & " Or Número de Salas LIKE '%" & Trim(Request("string_busca")) & "%'"
...
<SELECT name=campo_busca class=texto_pagina>
  ...
  <OPTION value="Endereço" <% If Trim(Request("campo_busca")) = Trim("Endereço") Then : Response.Write "selected" : End If %>>Endereço</OPTION>
  ...
  <OPTION value="Área Ocupada" <% If Trim(Request("campo_busca")) = Trim("Área Ocupada") Then : Response.Write "selected" : End If %>>Área Ocupada</OPTION>
  <OPTION value="Área Construída" <% If Trim(Request("campo_busca")) = Trim("Área Construída") Then : Response.Write "selected" : End If %>>Área Construída</OPTION>
  ...
  <OPTION value="Área Total" <% If Trim(Request("campo_busca")) = Trim("Área Total") Then : Response.Write "selected" : End If %>>Área Total</OPTION>
  <OPTION value="Número de Pavimentos" <% If Trim(Request("campo_busca")) = Trim("Número de Pavimentos") Then : Response.Write "selected" : End If %>>Número de Pavimentos</OPTION>
  <OPTION value="Número de Salas" <% If Trim(Request("campo_busca")) = Trim("Número de Salas") Then : Response.Write "selected" : End If %>>Número de Salas</OPTION>
  <OPTION value="Observação sobre o Prédio" <% If Trim(Request("campo_busca")) = Trim("Observação sobre o Prédio") Then : Response.Write "selected" : End If %>>Observação sobre o Prédio</OPTION>
</SELECT>
...
%>
  ...
  <TD style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Nome_Unidade+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 12) = "Nome_Unidade" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Nome_Unidade</b></TD>
  ...
  <TD style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Endereço+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 8) = "Endereço" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Endereço</b></TD>
  <TD width="61" valign=top nowrap style="cursor: hand" onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=CEP+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 3) = "CEP" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>CEP</b></TD>
  <TD width="107" valign=top nowrap style="cursor: hand" onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Complemento+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 11) = "Complemento" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Complemento</b></TD>
  <TD width="96" valign=top nowrap style="cursor: hand" onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Área Ocupada+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 12) = "Área Ocupada" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Área Ocupada</b></TD>
  <TD width="108" valign=top nowrap style="cursor: hand" onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Área Construída+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 15) = "Área Construída" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Área Construída</b></TD>
  <TD width="123" valign=top nowrap style="cursor: hand" onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Diretoria de Ensino+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 19) = "Diretoria de Ensino" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Diretoria de Ensino</b></TD>
  <TD width="76" valign=top nowrap style="cursor: hand" onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Área Total+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 10) = "Área Total" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Área Total</b></TD>
  <TD width="148" valign=top nowrap style="cursor: hand" onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Número de Pavimentos+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 20) = "Número de Pavimentos" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Número de Pavimentos</b></TD>
  <TD width="111" valign=top nowrap style="cursor: hand" onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Número de Salas+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 15) = "Número de Salas" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Número de Salas</b></TD>
  <TD width="168" valign=top nowrap style="cursor: hand" onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Observação sobre o Prédio+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 25) = "Observação sobre o Prédio" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%><b>Observação sobre o Prédio</b></TD>
  </TR>
...
%>
    ...
    <TD width="95"><%=(objRS.Fields.Item("cod_predio").Value)%></TD>
    <TD width="114"><%=(objRS.Fields.Item("Nome_Unidade").Value)%></TD>
    <TD width="85"><%=(objRS.Fields.Item("Município").Value)%></TD>
    <TD width="87"><%=(objRS.Fields.Item("Endereço").Value)%></TD>
    <TD><%=(objRS.Fields.Item("CEP").Value)%></TD>
    <TD><%=(objRS.Fields.Item("Complemento").Value)%></TD>
    <TD><%=(objRS.Fields.Item("Área Ocupada").Value)%></TD>
    <TD><%=(objRS.Fields.Item("Área Construída").Value)%></TD>
    <TD><%=(objRS.Fields.Item("Diretoria de Ensino").Value)%></TD>
    <TD><%=(objRS.Fields.Item("Área Total").Value)%></TD>
    <TD><%=(objRS.Fields.Item("Número de Pavimentos").Value)%></TD>
    <TD><%=(objRS.Fields.Item("Número de Salas").Value)%></TD>

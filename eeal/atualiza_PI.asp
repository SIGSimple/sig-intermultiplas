...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "atualiza_pi.asp"
  MM_fieldsStr  = "cod_mun|value|PI|value|Descrio_da_Interveno_FDE|value|cod_construtora|value|Nmero_do_Contrato|value|Dgito_do_Contrato|value|rgo|value|cod_fiscal|value|Gerenciadora_Mede_|value|cod_situacao|value|Data_do_TRP|value|Data_do_TRD|value"
  MM_columnsStr = "cod_mun|none,none,NULL|PI|none,none,NULL|[Descrição da Intervenção FDE]|',none,''|cod_construtora|none,none,NULL|[Número do Contrato]|none,none,NULL|[Dígito do Contrato]|none,none,NULL|Órgão|',none,''|cod_fiscal|none,none,NULL|[Gerenciadora Mede ?]|none,1,0|cod_situacao|none,none,NULL|[Data do TRP]|',none,NULL|[Data do TRD]|',none,NULL"
...
%>
    ...
    <tr valign="baseline" bgcolor="#999999">
      <td align="right" nowrap="nowrap" bgcolor="#EBEBEB"><span class="style1">Município</span></td>
      <td colspan="5" bgcolor="#EBEBEB">
		<select name="cod_mun" disabled="disabled" style="font-family: Arial Black; font-size: 10pt; font-weight: bold; color: #000000" size="1">
        <%
While (NOT rs_mun.EOF)
%>
        <option value="<%=(rs_mun.Fields.Item("cod_mun").Value)%>" <%If (Not isNull(rs_atualiza_pi.Fields.Item("cod_mun").Value)) Then If (CStr(rs_mun.Fields.Item("cod_mun").Value) = CStr(rs_atualiza_pi.Fields.Item("cod_mun").Value)) Then Response.Write("selected='selected'") : Response.Write("")%> ><%=(rs_mun.Fields.Item("Municipios").Value)%></option>
        <%
  rs_mun.MoveNext()
Wend
If (rs_mun.CursorType > 0) Then
  rs_mun.MoveFirst
Else
  rs_mun.Requery
End If
...
%>
    ...
    <tr valign="baseline" bgcolor="#999999">
      ...
      <td bgcolor="#EBEBEB"><input name="Nmero_do_Contrato" type="text" value="<%=(rs_atualiza_pi.Fields.Item("Número do Contrato").Value)%>" size="32" readonly="true" /></td>
      <td colspan="4" bgcolor="#EBEBEB"><div align="left"><strong><span class="style6">Dígito do Contrato</span></strong>
        <input name="Dgito_do_Contrato" type="text" value="<%=(rs_atualiza_pi.Fields.Item("Dígito do Contrato").Value)%>" size="10" readonly="true" />
    ...
    <tr valign="baseline" bgcolor="#999999">
      ...
      <td bgcolor="#EBEBEB"><input name="rgo" type="text" value="<%=(rs_atualiza_pi.Fields.Item("Órgão").Value)%>" size="32" readonly="true" /></td>
      <td bgcolor="#EBEBEB"><div align="right"><strong><span class="style6">Fiscal</span></strong></div></td>
      <td bgcolor="#EBEBEB">
		<select name="cod_fiscal" disabled="disabled" style="font-family: Arial Black; font-size: 10pt; color: #000000; font-weight: bold" size="1">
        <%
...
%>
      ...
      <td bgcolor="#EBEBEB"><div align="right"><span class="style1">Gerenciadora Mede ?</span></div></td>
      <td bgcolor="#EBEBEB"><input name="Gerenciadora_Mede_" type="checkbox" disabled="disabled" value=1 <%If (CStr((rs_atualiza_pi.Fields.Item("Gerenciadora Mede ?").Value)) = CStr("True")) Then Response.Write("checked=""checked""") : Response.Write("")%> /></td>
    </tr>
    <tr valign="baseline" bgcolor="#999999">
      <td align="right" nowrap bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB"><label for="select"></label>
        <select name="cod_situacao" id="select">
          <%
While (NOT rs_situacao.EOF)
%>
          <option value="<%=(rs_situacao.Fields.Item("id_situacao").Value)%>"><%=(rs_situacao.Fields.Item("desc_situacao").Value)%></option>
          <%
...
%>
    ...
    <tr valign="baseline" bgcolor="#999999">
      <td align="right" nowrap bgcolor="#EBEBEB">&nbsp;</td>
      <td bgcolor="#EBEBEB"><div align="right"><span class="style1">Data do TRP</span></div></td>
      <td bgcolor="#EBEBEB">
        <div align="left">
          <input name="Data_do_TRP" type="text" onblur="verifica_data(this)" onkeypress="desabilita_cor(this)" onkeyup="this.value=mascara_data(this.value)" value="<%=(rs_atualiza_pi.Fields.Item("Data do TRP").Value)%>" size="15" />
        </div></td>
      <td bgcolor="#EBEBEB"><div align="right"><strong><span class="style6">Data do TRD</span></strong></div></td>
      <td bgcolor="#EBEBEB"><input name="Data_do_TRD" type="text" onblur="verifica_data(this)" onkeypress="desabilita_cor(this)" onkeyup="this.value=mascara_data(this.value)" value="<%=(rs_atualiza_pi.Fields.Item("Data do TRD").Value)%>" size="15" /></td>
      <td bgcolor="#EBEBEB">&nbsp;</td>
    </tr>
    <tr valign="baseline" bgcolor="#999999">
      <td align="right" nowrap bgcolor="#EBEBEB">&nbsp;</td>

...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "tb_contrato_medicao_item"
  MM_editColumn = "id"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "cad_contrato_medicao_item.asp"
...
strQ = "SELECT * FROM c_lista_itens_medicao WHERE id = " + Replace(rs_delete_us__MMColParam, "'", "''") + ""
  ...
  <table border="0">
    ...
    <% While ((Repeat1__numRows <> 0) AND (NOT rs_delete_us.EOF)) %>
      <tr bgcolor="#CCCCCC">
        ...
        <td align="right">
          <span class="style5 vlr"><%=(rs_delete_us.Fields.Item("vlr_medido").Value)%></span>
        </td>
      </tr>
      <% 

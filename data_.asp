...
<table width="973" border="0">
  <tr>
    <td width="318"><form id="form1" name="form1" method="post" action="">
...
%>
    ...
    <td width="69"><a href=# onclick="Javascript:print()"><img src=imagens/imprimir.gif width="43" height="28" /></a></td>
    <td width="279">
...
<table cellspacing="0" cellpadding="0" width="100%" height="100%">
	<tr>
		<td align="center">
		<p align="right"><i><b><font face="Arial" size="2">Consórcio</font></b></i></td>
	</tr>
</table>
 </v:textbox>
...
height=30 src="data_arquivos/image001.gif" align=right v:shapes="_x0000_s1028"></span><![endif]></p>
	<p align="center"></td>
    <td width="118">
	<img border="0" src="imagens/Enger.jpg" width="100" height="29"></td>
    <td width="173">
	<img border="0" src="imagens/Planzervi.jpg" width="100" height="16"></td>
  </tr>
  <tr>
...
<table border="0">
  ...
  <% While ((Repeat1__numRows <> 0) AND (NOT Recordset1.EOF)) %>
    <tr bgcolor="#CCCCCC">
      ...
      <td><div align="center"><span class="style3"><%= FormatPercent((Recordset1.Fields.Item("Porcentagem de Avanço").Value), 2, -2, -2, -2) %></span></div></td>
...
width=6 height=1107 src="data_arquivos/image003.gif" v:shapes="_x0000_s1027"></span><![endif]></p>
</body>
</html>
<%
Recordset1.Close()

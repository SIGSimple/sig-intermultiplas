...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  MM_fieldsStr  = "PI|value|Data_do_Registro|value|Responsvel|value|Previso|value|Registro|value|vistoria|value"
  MM_columnsStr = "PI|',none,''|[Data do Registro]|',none,NULL|cod_fiscal|none,none,NULL|Previsão|',none,''|Registro|',none,''|vistoria|none,1,0"
...
If (CStr(Request("MM_update")) = "form2" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = ""
  MM_fieldsStr  = "Data_da_abertura|value|Data_do_TRP|value|Data_do_TRD|value|cod_situacao|value|Foi_solicitado_Aditamento|value|Valor_do_Aditamento|value"
  MM_columnsStr = "[Data da Abertura]|',none,NULL|[Data do TRP]|',none,NULL|[Data do TRD]|',none,NULL|cod_situacao|none,none,NULL|[Foi solicitado Aditamento?]|none,1,0|[Valor do Aditamento]|',none,''"
...
<div align="center">
  ...
  <table width="823" border="0">
    <tr bgcolor="#FFFFFF">
      <td bgcolor="#FFFFFF" class="style27"><a href="med_constr_inclui.asp?pi=<%=(rs_pi.Fields.Item("PI").Value)%>" target="_blank">Medi&ccedil;&otilde;es</a></td>
    </tr>
  </table>
...
%>
    ...
    <tr valign="baseline">
      <td align="right" nowrap="nowrap" bordercolor="#CCCCCC" bgcolor="#CCCCCC"><span class="style5">Vistoria:</span></td>

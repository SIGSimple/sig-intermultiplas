...
strQ = "select * from tb_app where id = " + Replace(rs_delete_us__MMColParam, "'", "''") + ""
...
<div align="center">
  <table border="0">
    <tr bgcolor="#CCCCCC">
      <td>
        <span class="style5">Núm. Autorização</span>
      </td>
      <td>
    ...
    <% While ((Repeat1__numRows <> 0) AND (NOT rs_delete_us.EOF)) %>
      <tr bgcolor="#CCCCCC">
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("num_app").Value)%></span>
        </td>
        <td>

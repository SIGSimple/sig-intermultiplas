...
strQ = "SELECT * FROM c_lista_agencias_cetesb WHERE id = " + Replace(rs_delete_us__MMColParam, "'", "''") + ""
...
<div align="center">
  <table border="0">
    <tr bgcolor="#CCCCCC">
      <td>
        <span class="style5">Agência Ambiental de(o)</span>
      </td>
      <td>
        <span class="style5">Endereço</span>
      </td>
      <td>
        <span class="style5">Bairro</span>
      </td>
      <td>
        <span class="style5">Cidade/Município</span>
      </td>
      <td>
        <span class="style5">CEP</span>
      </td>
      <td>
        <span class="style5">Telefone</span>
      </td>
      <td>
        <span class="style5">Fax</span>
      </td>
      <td>
    ...
    <% While ((Repeat1__numRows <> 0) AND (NOT rs_delete_us.EOF)) %>
      <tr bgcolor="#CCCCCC">
        ...
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("dsc_endereco").Value)%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("dsc_bairro").Value)%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("nme_municipio").Value)%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("num_cep").Value)%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("num_telefone").Value)%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("num_fax").Value)%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("end_email").Value)%></span>
        </td>
      </tr>
      <% 

...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="994" border="0">
    <tr bgcolor="#CCCCCC">
      <td colspan="2" class="style10">RELAT&Oacute;RIO DE OBRAS - <strong>SEMAF&Oacute;RICO</strong><strong class="style10"> - por PI</strong></td>
...
%>
  ...
  <span class="style12"><%=(Recordset3.Fields.Item("desc_situacao").Value)%></span>
</form>
<table width="2243" border="0">
  ...
  <tr bgcolor="#CCCCCC">
    ...
    <td class="style3"><%=(Recordset1.Fields.Item("Responsável").Value)%></td>
    ...
    <td class="style3"><%=(Recordset1.Fields.Item("Data Prevista para o Término").Value)%></td>

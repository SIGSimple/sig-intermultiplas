...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "tb_contrato_aditamento"
  MM_editColumn = "id"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "cad_contrato_aditamento.asp"
...
strQ = "SELECT * FROM tb_contrato_aditamento WHERE id = " + Replace(rs_delete_us__MMColParam, "'", "''") + ""
...
<div align="center">
  <table border="0">
    ...
    <% While ((Repeat1__numRows <> 0) AND (NOT rs_delete_us.EOF)) %>
      <tr bgcolor="#CCCCCC">
        <td>
          <span class="style5"><%=(Request.QueryString("num_aditamento"))%></span>
        </td>
      </tr>
      <% 

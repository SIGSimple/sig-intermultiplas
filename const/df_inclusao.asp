...
If Not IsEmpty(Request.Form) Then
  ...
  If campo_duplicado = false Then
    ...
    objRS.CursorType = 0
    objRS.LockType = 3
    strQ = "SELECT * FROM tb_Construtora Where 1 <> 1"
...
<BR><B>Registro salvo</B><BR>O registro foi cadastrado com sucesso.<BR><BR>
...
<B>Incluir um novo registro</B><BR>Preencha corretamente os dados abaixo:<BR>
...
<%If objRS.Fields("cod_construtora").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="cod_construtora" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
...
<%If objRS.Fields("Construtora").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Construtora" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("Endereço da Construtora").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Endereço da Construtora" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("cep_empresa").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="cep_empresa" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%
  ...
  If Not objRS2.EOF Then
    ...
    If Trim(objRS2.Fields.Item("Municipios").Value) <> "" Then
      Response.Write "      <OPTION value='" & (objRS2.Fields.Item("cod_mun").Value) & "'>" & (objRS2.Fields.Item("Municipios").Value) & "</OPTION>"
    End If
      objRS2.MoveNext
    Wend
  End If
...
<%If objRS.Fields("email_empresa").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="email_empresa" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("site_empresa").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="site_empresa" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("Fone da Construtora").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Fone da Construtora" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("cnpj_empresa").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="cnpj_empresa" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("Engenheiro responsável").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Engenheiro responsável" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("Número do CREA").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Número do CREA" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("telefone_responsavel").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="telefone_responsavel" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
  Response.Write "<B>(Automático)</B>"
End If
...
<%If objRS.Fields("email_responsavel").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="email_responsavel" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class="campos_formulario">
<%
Else
  Response.Write "<B>(Automático)</B>"
End If

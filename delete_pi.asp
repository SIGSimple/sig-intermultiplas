...
<div align="center">
  <table border="1">
    <tr bgcolor="#666666">
      ...
      <td><span class="style7">Eng. Obras Consórcio</span></td>
    ...
    <% While ((Repeat1__numRows <> 0) AND (NOT Recordset1.EOF)) %>
      <tr bgcolor="#CCCCCC">
        ...
        <td><div align="left"><span class="style5"><%=(Recordset1.Fields.Item("Município").Value)%></span></div></td>
        <td><div align="left"><span class="style5"><%=(Recordset1.Fields.Item("Responsável").Value)%></span></div></td>

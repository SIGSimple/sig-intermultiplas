...
If Not IsEmpty(Request.Form("salvar")) Then
  ...
  If indice <> "" Then strQ = " SELECT * FROM tb_contrato WHERE " & indice
...
<%If objRS.Fields("area_construida").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="area_construida" maxlength="255" value="<%=(objRS.Fields.Item("area_construida").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("area_construida").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>area_gerenciadora<br>
<%If objRS.Fields("area_gerenciadora").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="area_gerenciadora" maxlength="255" value="<%=(objRS.Fields.Item("area_gerenciadora").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("area_gerenciadora").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>cod_contrato<br>
<%If objRS.Fields("cod_contrato").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="cod_contrato" maxlength="255" value="<%=(objRS.Fields.Item("cod_contrato").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("cod_contrato").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>cod_predio<br>
<%If objRS.Fields("cod_predio").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="cod_predio" maxlength="255" value="<%=(objRS.Fields.Item("cod_predio").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
...
<%If objRS.Fields("cod_reg").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="cod_reg" maxlength="255" value="<%=(objRS.Fields.Item("cod_reg").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("cod_reg").Value) & "</B>"
End If
%>
  </TD></TR>
  ...
  If Not objRS2.EOF Then
    While Not objRS2.EOF
	  If Trim(objRS2.Fields.Item("Construtora").Value) <> "" Then
	    Response.Write "      <OPTION value='" & (objRS2.Fields.Item("Construtora").Value) & "'"
	    If Lcase(objRS2.Fields.Item("Construtora").Value) = Lcase(objRS.Fields.Item("Construtora").Value) then
...
<%If objRS.Fields("crit_calculo").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="crit_calculo" maxlength="255" value="<%=(objRS.Fields.Item("crit_calculo").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("crit_calculo").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>crit_reajuste<br>
<%If objRS.Fields("crit_reajuste").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="crit_reajuste" maxlength="255" value="<%=(objRS.Fields.Item("crit_reajuste").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("crit_reajuste").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>desc_interv_gerenciadora<br>
<%If objRS.Fields("desc_interv_gerenciadora").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="desc_interv_gerenciadora" maxlength="255" value="<%=(objRS.Fields.Item("desc_interv_gerenciadora").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("desc_interv_gerenciadora").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>Desc_intervencao_FDE<br>
<%If objRS.Fields("Desc_intervencao_FDE").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="Desc_intervencao_FDE" maxlength="255" value="<%=(objRS.Fields.Item("Desc_intervencao_FDE").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("Desc_intervencao_FDE").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>dig_contrato<br>
<%If objRS.Fields("dig_contrato").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="dig_contrato" maxlength="255" value="<%=(objRS.Fields.Item("dig_contrato").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("dig_contrato").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>dt_abertura<br>
<%If objRS.Fields("dt_abertura").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="dt_abertura" maxlength="255" value="<%=(objRS.Fields.Item("dt_abertura").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("dt_abertura").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>dt_assinatura<br>
<%If objRS.Fields("dt_assinatura").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="dt_assinatura" maxlength="255" value="<%=(objRS.Fields.Item("dt_assinatura").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("dt_assinatura").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>dt_base<br>
<%If objRS.Fields("dt_base").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="dt_base" maxlength="255" value="<%=(objRS.Fields.Item("dt_base").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("dt_base").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>dt_CI<br>
<%If objRS.Fields("dt_CI").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="dt_CI" maxlength="255" value="<%=(objRS.Fields.Item("dt_CI").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("dt_CI").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>dt_impressao_ois<br>
<%If objRS.Fields("dt_impressao_ois").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="dt_impressao_ois" maxlength="255" value="<%=(objRS.Fields.Item("dt_impressao_ois").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("dt_impressao_ois").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>dt_termino<br>
<%If objRS.Fields("dt_termino").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="dt_termino" maxlength="255" value="<%=(objRS.Fields.Item("dt_termino").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("dt_termino").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>dt_TRD<br>
<%If objRS.Fields("dt_TRD").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="dt_TRD" maxlength="255" value="<%=(objRS.Fields.Item("dt_TRD").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("dt_TRD").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>dt_TRP<br>
<%If objRS.Fields("dt_TRP").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="dt_TRP" maxlength="255" value="<%=(objRS.Fields.Item("dt_TRP").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("dt_TRP").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>fator_reducao<br>
<%If objRS.Fields("fator_reducao").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="fator_reducao" maxlength="255" value="<%=(objRS.Fields.Item("fator_reducao").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("fator_reducao").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>fical<br>
<%If objRS.Fields("fical").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="fical" maxlength="255" value="<%=(objRS.Fields.Item("fical").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("fical").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>
  <input name="gerenc_mede" type="checkbox" <% if Lcase(Left(objRS.Fields.Item("gerenc_mede").Value,1)) <> "f" then : Response.Write " checked" : End If %>>gerenc_mede
  </TD></TR>
  <TR class=titulo_campos><TD>
  <input name="Obra_pi" type="checkbox" <% if Lcase(Left(objRS.Fields.Item("Obra_pi").Value,1)) <> "f" then : Response.Write " checked" : End If %>>Obra_pi
  </TD></TR>
  <TR class=titulo_campos><TD>orc_FDE<br>
<%If objRS.Fields("orc_FDE").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="orc_FDE" maxlength="255" value="<%=(objRS.Fields.Item("orc_FDE").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("orc_FDE").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>orgao<br>
<%If objRS.Fields("orgao").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="orgao" maxlength="255" value="<%=(objRS.Fields.Item("orgao").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("orgao").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>PI<br>
<%If objRS.Fields("PI").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="PI" maxlength="255" value="<%=(objRS.Fields.Item("PI").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("PI").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>prz_contrato<br>
<%If objRS.Fields("prz_contrato").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="prz_contrato" maxlength="255" value="<%=(objRS.Fields.Item("prz_contrato").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("prz_contrato").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>reducao<br>
<%If objRS.Fields("reducao").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="reducao" maxlength="255" value="<%=(objRS.Fields.Item("reducao").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("reducao").Value) & "</B>"
End If
%>
  </TD></TR>
  <TR class=titulo_campos><TD>
  <input name="solic_aditamento" type="checkbox" <% if Lcase(Left(objRS.Fields.Item("solic_aditamento").Value,1)) <> "f" then : Response.Write " checked" : End If %>>solic_aditamento
  </TD></TR>
  <TR class=titulo_campos><TD>vl_contrato<br>
<%If objRS.Fields("vl_contrato").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="vl_contrato" maxlength="255" value="<%=(objRS.Fields.Item("vl_contrato").Value)%>" onKeyPress="desabilita_cor(this)"  df_verificar="sim" class=campos_formulario>
<%
Else
  Response.Write "<B>" & (objRS.Fields.Item("vl_contrato").Value) & "</B>"
End If
%>
  </TD></TR>
</TABLE>

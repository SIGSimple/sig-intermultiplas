...
rs.Source = "SELECT * FROM tb_tcra WHERE id = " + Replace(rs__MMColParam, "'", "''")
rs.CursorType = 0
rs.CursorLocation = 2
rs.LockType = 1
rs.Open()
...
<body>
<p align="center"><strong><span class="style17">Alteração de TCRA </span></strong></p>
    <form method="post" action="<%=MM_editAction%>" name="form1">
      ...
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td bgcolor="#CCCCCC">
            <input type="text" name="cod_tcra" value="<%=(rs.Fields.Item("cod_tcra").Value)%>" size="10">
          </td>
        </tr>
        <tr valign="baseline">
          <td align="right" nowrap bgcolor="#CCCCCC" class="style7">

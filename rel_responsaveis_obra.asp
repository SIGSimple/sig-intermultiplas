...
<%
	...
	sql = "SELECT * FROM c_lista_rel_responsaveis_empreendimento"
	...
	<script type="text/javascript">
		$(function(){
			...
			$("li a.excel").on("click", function(){
				$("table").table2excel({
					name: "Listagem de Responsáveis p/ Obra"
				});
			});
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">SIG - Listagem de Responsáveis p/ Obra</a>
			</div>
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-xs-8 text-center">
						<h3><strong>Listagem de Responsáveis p/ Obra</strong><br/><small>Listagem do Banco de Dados</small></h3>
					</div>

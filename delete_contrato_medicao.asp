...
if (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editTable = "tb_contrato_medicao"
  MM_editColumn = "id"
  MM_recordId = "" + Request.Form("MM_recordId") + ""
  MM_editRedirectUrl = "cad_contrato_medicao.asp"
...
strQ = "SELECT tb_contrato_medicao.*, Month([dta_medicao]) AS mes_medicao, Year([dta_medicao]) AS ano_medicao FROM tb_contrato_medicao WHERE id = " + Replace(rs_delete_us__MMColParam, "'", "''") + ""
    ...
    <% While ((Repeat1__numRows <> 0) AND (NOT rs_delete_us.EOF)) %>
      <tr bgcolor="#CCCCCC">
        <td>
          <span class="style5">
            <%
              mes = CaptalizeText(MonthName(rs_delete_us.Fields.Item("mes_medicao").Value,True))
              ano = rs_delete_us.Fields.Item("ano_medicao").Value

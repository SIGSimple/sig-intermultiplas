...
If (Request.Form("PI") <> "") Then 
  Recordset1__MMColParam = Request.Form("PI")
End If
%>
<%
Dim Recordset1
...
Recordset1_cmd.CommandText = "SELECT * FROM cLista_pi WHERE PI LIKE ?" 
...
<body>
<p><a href="http://www.cep-escolas.com.br/busca_pi_cod_fiscal.asp" class="style15">VOLTAR</a></p>

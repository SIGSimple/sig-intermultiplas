...
strQ = "SELECT * FROM c_lista_licencas_ambientais WHERE id = " + Replace(rs_delete_us__MMColParam, "'", "''") + ""
...
<div align="center">
  <table border="0">
    <tr bgcolor="#CCCCCC">
      <td>
        <span class="style5">Núm. Licença</span>
      </td>
      <td>
        <span class="style5">Tipo de Licença</span>
      </td>
      <td>
    ...
    <% While ((Repeat1__numRows <> 0) AND (NOT rs_delete_us.EOF)) %>
      <tr bgcolor="#CCCCCC">
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("num_licenca").Value)%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("dsc_tipo_licenca").Value)%></span>
        </td>
        <td>

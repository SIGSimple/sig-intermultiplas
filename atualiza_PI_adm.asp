...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "atualiza_pi_adm.asp"
  MM_fieldsStr  = "PI|value|Descrio_da_Interveno_FDE|value|cod_construtora|value|Nmero_do_Contrato|value|Dgito_do_Contrato|value|rgo|value|cod_fiscal|value|Gerenciadora_Mede_|value|cod_situacao|value|Data_da_abertura|value|Data_do_TRP|value|Data_do_TRD|value"
...
%>
    ...
    <tr valign="baseline" bgcolor="#999999">
      ...
      <td colspan="4" bgcolor="#EBEBEB"><div align="left"><strong><span class="style6">Descrição da Intervenção FDE</span></strong>
            <textarea name="Descrio_da_Interveno_FDE" cols="32" rows="" class="style6"><%=(rs_atualiza_pi.Fields.Item("Descrição da Intervenção FDE").Value)%></textarea>
      </div></td>
    </tr>
    <tr valign="baseline" bgcolor="#999999">
      <td align="right" nowrap="nowrap" bgcolor="#EBEBEB"><span class="style1">Construtora</span></td>
      <td colspan="5" bgcolor="#EBEBEB"><select name="cod_construtora" class="style6">
...
%>
    ...
    <tr valign="baseline" bgcolor="#999999">
      ...
      <td bgcolor="#EBEBEB"><input name="Nmero_do_Contrato" type="text" class="style6" value="<%=(rs_atualiza_pi.Fields.Item("Número do Contrato").Value)%>" size="32" /></td>
      <td colspan="4" bgcolor="#EBEBEB"><div align="left"><strong><span class="style6">Dígito do Contrato</span></strong>
        <input name="Dgito_do_Contrato" type="text" class="style6" value="<%=(rs_atualiza_pi.Fields.Item("Dígito do Contrato").Value)%>" size="10" />
        <a target="_blank" href="contratos_adm.asp?pi=<%=(rs_atualiza_pi.Fields.Item("PI").Value)%>">
    ...
    <tr valign="baseline" bgcolor="#999999">
      ...
      <td bgcolor="#EBEBEB"><input name="rgo" type="text" class="style6" value="<%=(rs_atualiza_pi.Fields.Item("Órgão").Value)%>" size="32" /></td>
      <td width="113" bgcolor="#EBEBEB"><div align="right"><strong><span class="style6">Fiscal</span></strong></div></td>
      <td width="90" bgcolor="#EBEBEB"><select name="cod_fiscal">
...
%>
      ...
      <td width="90" bgcolor="#EBEBEB"><input name="Gerenciadora_Mede_" type="checkbox" value=1 <%If (CStr((rs_atualiza_pi.Fields.Item("Gerenciadora Mede ?").Value)) = CStr("True")) Then Response.Write("checked=""checked""") : Response.Write("")%> /></td>
    </tr>
    <tr valign="baseline" bgcolor="#999999">

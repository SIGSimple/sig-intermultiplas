...
<table border="0">
  <tr bgcolor="#999999">
    <td width="128"><span class="style7">cod_predio</span></td>
    <td width="388"><span class="style7">Nome Unidade</span></td>
    <td width="150"><span class="style7">PI</span></td>
    <td colspan="2"><div align="center" class="style9">A&Ccedil;&Otilde;ES</div></td>
  </tr>
  <% While ((Repeat1__numRows <> 0) AND (NOT rs_PIS.EOF)) %>
    <tr bgcolor="#EFEFEF" class="style10">
      ...
      <td width="151" bgcolor="#FFEFE8" class="style14 style15"><%=(rs_PIS.Fields.Item("desc_situacao").Value)%></td>
      <td width="160" bgcolor="#FFEFE8" class="style5"><strong class="style8"><a href="acompanhamento_inclui.asp?pi=<%=(rs_PIS.Fields.Item("PI").Value)%>" target="_blank">Acompanhamento</a></strong></td>
    </tr>
    <% 

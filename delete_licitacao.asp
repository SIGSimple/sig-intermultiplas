...
strQ = "select * from c_lista_licitacoes where id = " + Replace(rs_delete_us__MMColParam, "'", "''") + ""
...
<div align="center">
  <table border="0">
    <tr bgcolor="#CCCCCC">
      <td>
        <span class="style5">Núm. Autos</span>
      </td>
      <td>
        <span class="style5">Tipo de Contratação</span>
      </td>
      <td>
        <span class="style5">Financiador</span>
      </td>
      <td>
        <span class="style5">Modalidade de Contratação</span>
      </td>
      <td>
        <span class="style5">Núm. Edital</span>
      </td>
      <td>
        <span class="style5">Data de Publicação D.O.E</span>
      </td>
      <td>
    ...
    <% While ((Repeat1__numRows <> 0) AND (NOT rs_delete_us.EOF)) %>
      <tr bgcolor="#CCCCCC">
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("num_autos"))%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("dsc_tipo_contratacao").Value)%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("dsc_financiador").Value)%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("dsc_modalidade").Value)%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("num_edital").Value)%></span>
        </td>
        <td>
          <span class="style3"><%=(rs_delete_us.Fields.Item("dta_publicacao_doe").Value)%></span>
        </td>
        <td>

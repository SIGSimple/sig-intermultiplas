...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "cad_app.asp"
  MM_fieldsStr  = "num_app|value|dta_concessao|value|dta_vencimento|value|dsc_observacoes|value|flg_receber_notificacoes|value"
  MM_columnsStr = "num_app|',none,''|dta_concessao|',none,NULL|dta_vencimento|',none,NULL|dsc_observacoes|',none,''|flg_receber_notificacoes|none,1,0"
...
rs.Source = "SELECT * FROM tb_app WHERE id = " + Replace(rs__MMColParam, "'", "''")
rs.CursorType = 0
rs.CursorLocation = 2
rs.LockType = 1
rs.Open()
...
<body>
<p align="center"><strong><span class="style17">Alteração de Intervenção em App </span></strong></p>
    <form method="post" action="<%=MM_editAction%>" name="form1">
      ...
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td bgcolor="#CCCCCC">
            <input type="text" name="num_app" value="<%=(rs.Fields.Item("num_app").Value)%>" size="10">
          </td>
        </tr>
        <tr valign="baseline">
          <td align="right" nowrap bgcolor="#CCCCCC" class="style7">

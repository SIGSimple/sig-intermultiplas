...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_fieldsStr  = "num_app|value|dta_concessao|value|dta_vencimento|value|dsc_observacoes|value"
  MM_columnsStr = "num_app|',none,''|dta_concessao|',none,NULL|dta_vencimento|',none,NULL|dsc_observacoes|',none,''"

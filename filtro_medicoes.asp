...
<!--mstheme--><link rel="stylesheet" type="text/css" href="_themes/expeditn/expe1011-28591.css"><meta name="Microsoft Theme" content="expeditn 1011">
</head>

<body onload="FP_preloadImgs(/*url*/'button52.jpg', /*url*/'button53.jpg')">
<form id="form1" name="form1" method="post" action="filtro_exibir_medicoes.asp?cod_predio=<%=(Recordset1.Fields.Item("cod_predio").Value)%>">
  <label>
  <div align="center">

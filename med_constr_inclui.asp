...
<div align="center">
  <table border="0">
    ...
    <% While ((Repeat1__numRows <> 0) AND (NOT rs_med_constr.EOF)) %>
      <tr bgcolor="#CCCCCC">
        <td><a href="altera_med_constr.asp?cod_med_constr=<%=(rs_med_constr.Fields.Item("cod_med_constr").Value)%>"><img src="cidades/imagens/edit.gif" width="16" height="15" border="0" /></a></td>
        <td><a href="exc_med_constr.asp?cod_med_constr=<%=(rs_med_constr.Fields.Item("cod_med_constr").Value)%>"><img src="imagens/delete.gif" width="16" height="15" border="0" /></a></td>

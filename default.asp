...
<body class="login">
	<section id="login">
		<div class="container container-login" style="margin-top: 80px;">
			<div class="row">
				<div class="col-xs-6 text-center">
					<img src="LogoProjetoAguaLimpa.jpg" class="logo-intermultiplas"/>
				</div>
		...
		<img src="Consórcio Maior.jpg" class="specialImage" />
	</section>
	...
	<footer id="footer">
		<div class="container">
			<div class="row">
				<div class="col-xs-12">
					<p><strong>Secretaria de Saneamento e Recursos Hídricos</strong></p>
					<p>DAEE - Departamento de Águas e Energia Elétrica</p>
					<p>Consórcio Intermultiplas © - 2015</p>
				</div>
			</div>
		</div>
	</footer>

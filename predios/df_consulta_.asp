...
%>
    ...
    <td style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Nome_Unidade+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 12) = "Nome_Unidade" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%>
        <b>Nome_Unidade</b></td>
    <td style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Endereço+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 8) = "Endereço" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%>
        <b>Endereço</b></td>
    ...
    <td style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=CEP+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 3) = "CEP" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%>
        <b>CEP</b></td>
    <td style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Área Construída+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 15) = "Área Construída" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%>
        <b>Área Construída</b></td>
    <td style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Diretoria de Ensino+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 19) = "Diretoria de Ensino" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%>
	   ...
	   <td style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Município+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 19) = "Município" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%>
        <b>Município</b></td>	
    <td style="cursor: hand" valign=top nowrap onClick="window.open('<%=Request.ServerVariables("SCRIPT_NAME")%>?Ordem=Número de Pavimentos+<%=Ordem%>', '_self')"><%If Left(Request.QueryString("Ordem"), 19) = "Número de Pavimentos" Then : Response.Write "<img src=""imagens\ordem_" & Ordem & ".gif"" width=9 height=10>&nbsp;" : End If%>
        <b>Número de Pavimentos</b></td>
  </tr>
  <%

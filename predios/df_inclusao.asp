...
If Not IsEmpty(Request.Form) Then
  ...
  If campo_duplicado = false Then
    ...
    objRS.CursorType = 0
    objRS.LockType = 3
    strQ = "SELECT * FROM tb_predio Where 1 <> 1"
    ...
    last_id = objRS.Fields.Item("id_predio").Value

    objRS.Close
    Set objRS = Nothing

    objCon.Execute("UPDATE tb_predio SET cod_predio = "& last_id &" WHERE id_predio = "& last_id)
    objCon.Close
...
<%If objRS.Fields("id_predio").properties("IsAutoIncrement") = False Then%>
<INPUT style="width=350" type="text" name="id_predio" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
<%
Else
...
<%
  ...
  If Not objRS2.EOF Then
    ...
    If Trim(objRS2.Fields.Item("Municipios").Value) <> "" Then
      Response.Write "      <OPTION value='" & (objRS2.Fields.Item("Municipios").Value) & "'>" & (objRS2.Fields.Item("Municipios").Value) & "</OPTION>"
    End If
      objRS2.MoveNext
    Wend
  End If
...
<%
  ...
  If Not objRS2.EOF Then
    ...
    If Trim(objRS2.Fields.Item("desc_diretoria").Value) <> "" Then
      Response.Write "      <OPTION value='" & (objRS2.Fields.Item("desc_diretoria").Value) & "'>" & (objRS2.Fields.Item("desc_diretoria").Value) & "</OPTION>"
    End If
      objRS2.MoveNext
    Wend
  End If
...
<%
  ...
  If Not objRS2.EOF Then
    While Not objRS2.EOF
    If Trim(objRS2.Fields.Item("desc_diretoria").Value) <> "" Then
      Response.Write "      <OPTION value='" & (objRS2.Fields.Item("id").Value) & "'>" & (objRS2.Fields.Item("desc_diretoria").Value) & "</OPTION>"
    End If
      objRS2.MoveNext
    Wend
  End If
...
<%
  ...
  If Not objRS2.EOF Then
    ...
    If Trim(objRS2.Fields.Item("Construtora").Value) <> "" Then
      Response.Write "      <OPTION value='" & (objRS2.Fields.Item("cod_construtora").Value) & "'>" & (objRS2.Fields.Item("Construtora").Value) & "</OPTION>"
    End If
      objRS2.MoveNext
    Wend
  End If
...
<%
  ...
  If Not objRS2.EOF Then
    ...
    If Trim(objRS2.Fields.Item("Responsável").Value) <> "" Then
      Response.Write "      <OPTION value='" & (objRS2.Fields.Item("cod_fiscal").Value) & "'>" & (objRS2.Fields.Item("Responsável").Value) & "</OPTION>"
    End If
      objRS2.MoveNext
    Wend
  End If
  ...
  <TR class=titulo_campos>
    <TD>
      ...
      <%
        If objRS.Fields("ano_inicio_adm").properties("IsAutoIncrement") = False Then
      %>
      De: <INPUT type="text" style="width: 50px;" name="ano_inicio_adm" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
      <%
        Else
          Response.Write "<B>(Automático)</B>"
        End If
      ...
      <%
        If objRS.Fields("ano_fim_adm").properties("IsAutoIncrement") = False Then
      %>
      Até: <INPUT type="text" style="width: 50px;" name="ano_fim_adm" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
      <%
        Else
          Response.Write "<B>(Automático)</B>"
        End If
...
<%
  ...
  If Not objRS2.EOF Then
    ...
    If Trim(objRS2.Fields.Item("nme_partido").Value) <> "" Then
      Response.Write "      <OPTION value='" & (objRS2.Fields.Item("id").Value) & "'>" & (objRS2.Fields.Item("nme_partido").Value) & "</OPTION>"
    End If
      objRS2.MoveNext
    Wend
  End If
...
%>
  ...
  <TR class=titulo_campos>
    <TD>
      ...
      <%
        If objRS.Fields("qtd_populacao_urbana_2010").properties("IsAutoIncrement") = False Then
      %>
      <INPUT style="width=350" type="text" name="qtd_populacao_urbana_2010" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
      <%
        Else
          Response.Write "<B>(Automático)</B>"
        End If
  ...
  <TR class=titulo_campos>
    <TD>
      ...
      <%
        If objRS.Fields("qtd_populacao_urbana_2030").properties("IsAutoIncrement") = False Then
      %>
      <INPUT style="width=350" type="text" name="qtd_populacao_urbana_2030" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
      <%
        Else
          Response.Write "<B>(Automático)</B>"
        End If
  ...
  <TR class=titulo_campos>
    <TD>
      ...
      <%If objRS.Fields("Observação sobre o Prédio").properties("IsAutoIncrement") = False Then%>
      <input type="checkbox" id="flg_atendido_sabesp" name="flg_atendido_sabesp" value="0" />
      <%Else Response.Write "<B>(Automático)</B>" End If %>
    </TD>
  </TR>
...
<%
  ...
  If Not objRS2.EOF Then
    ...
    If Trim(objRS2.Fields.Item("dsc_concessao").Value) <> "" Then
      Response.Write "      <OPTION value='" & (objRS2.Fields.Item("id").Value) & "'>" & (objRS2.Fields.Item("dsc_concessao").Value) & "</OPTION>"
    End If
      objRS2.MoveNext
    Wend
  End If
...
%>
  ...
  <TR class=titulo_campos>
    <TD>
      ...
      <%
        If objRS.Fields("latitude_longitude").properties("IsAutoIncrement") = False Then
      %>
      <INPUT style="width=350" type="text" name="latitude_longitude" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
      <%
        Else
          Response.Write "<B>(Automático)</B>"
        End If
  ...
  <TR class=titulo_campos>
    <TD>
      ...
      <br>
      <%If objRS.Fields("Observação sobre o Prédio").properties("IsAutoIncrement") = False Then%>
      <INPUT style="width=350" type="text" name="Observação sobre o Prédio" maxlength="255" value="" onKeyPress="desabilita_cor(this)" class=campos_formulario>
      <%Else Response.Write "<B>(Automático)</B>" End If %>
    </TD>
  </TR>
</TABLE>
